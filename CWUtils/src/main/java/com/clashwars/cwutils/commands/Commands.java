...
public class Commands {
    ...
    public boolean vote(CommandSender sender, String label, String argument, String... args) {
        ...
        sender.sendMessage(Utils.integrateColor("&6&lMain voting page&8&l:&9&l http://clashwars.com/vote"));
        sender.sendMessage(Utils.integrateColor("&8★ &6Site 1 (PMC)&8:&3 http://goo.gl/Vmkp7q"));
        sender.sendMessage(Utils.integrateColor("&8★ &6Site 2 (MS)&8:&3 http://goo.gl/ddmZv1"));
        sender.sendMessage(Utils.integrateColor("&8★ &6Site 3 (MCSL)&8:&3 http://goo.gl/30re1M"));
        sender.sendMessage(Utils.integrateColor("&7&oplease also &4&ofavorite❤ &7&oand give a &b&odiamond✦ &7&oon pmc. &e:)"));
        return true;
    }
